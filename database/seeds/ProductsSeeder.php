    ...
    public function run()
    {
        ...
        $data = [
            [
                ...
                'content' => '<p>Часто описание товара пишут для всех. Автор не концентрируется на целевом, идеальном покупателе.</p>',
                'price' => 300,
                'old_price' => 250,
                'status' => '1',
                'keywords' => 'watch',
                'description' => 'Чтобы покупатель так не думал, составляйте описание товара четко и без воды, прописывайте каждое преимущество и его пользу. Тогда покупатели вам поверят и купят товар.',
                'img' => '1.png',
                'hit' => '1',
            ],
            [
                ...
                'content' => '<p>Покупателю не интересно читать перечень характеристик и преимуществ товара. Ему нужно знать, что он получит от этих преимуществ.</p>',
                'price' => 200,
                'old_price' => 200,
                'status' => '1',
                'keywords' => 'watch',
